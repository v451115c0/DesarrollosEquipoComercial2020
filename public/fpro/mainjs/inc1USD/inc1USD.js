                ...
                "render": function(data, type, row){
                    ...
                    if(row.existe == 1){
                        ...
                        return '<div class="btn-group dropup ">' +
                                    ...
                                    '<div class="dropdown-menu text-center">' +
                                        '<a href="javascript:void(0);" class="dropdown-item text-black"><b><span id="logBTN">Elegir País</span></b></a>' +
                                        '<a onclick="disableButton(\'' + row.CodigoBoleto.trim() + '\'); navigationTracking(' + row.SponsorId.trim() + ', \'Mokuteki PLUS\', \'redime kit: ' + row.CodigoBoleto.trim() + ' en: COL\')" target="_blank" href="https://iw.nikkenlatam.com:8787/login-cupon-incorporate.php?sponsorid=' + window.btoa(row.SponsorId.trim()) + '&kit=' + window.btoa(5002) + '&boleto=' + window.btoa(row.CodigoBoleto.trim()) + '" class="dropdown-item" id="COL">Colombia &nbsp;&nbsp;<img src="../fpro/img/flags/' + flags['COL'] + '" width="20px"></a>' +
                                        '<a onclick="disableButton(\'' + row.CodigoBoleto.trim() + '\'); navigationTracking(' + row.SponsorId.trim() + ', \'Mokuteki PLUS\', \'redime kit: ' + row.CodigoBoleto.trim() + ' en: LAT\')" target="_blank" href="https://iw.nikkenlatam.com:8787/mexico/login-cupon-incorporate.php?sponsorid=' + window.btoa(row.SponsorId.trim()) + '&kit=' + window.btoa(5002) + '&boleto=' + window.btoa(row.CodigoBoleto.trim()) +'" class="dropdown-item" id="LAT">México &nbsp;&nbsp;<img src="../fpro/img/flags/' + flags['LAT'] + '" width="20px"></a>' +
                                        '<a onclick="disableButton(\'' + row.CodigoBoleto.trim() + '\'); navigationTracking(' + row.SponsorId.trim() + ', \'Mokuteki PLUS\', \'redime kit: ' + row.CodigoBoleto.trim() + ' en: PER\')" target="_blank" href="https://iw.nikkenlatam.com:8787/peru/login-cupon-incorporate.php?sponsorid=' + window.btoa(row.SponsorId.trim()) + '&kit=' + window.btoa(5002) + '&boleto=' + window.btoa(row.CodigoBoleto.trim()) + '" class="dropdown-item" id="PER">Perú &nbsp;&nbsp;<img src="../fpro/img/flags/' + flags['PER'] + '" width="20px"></a>' +
                                        '<a onclick="disableButton(\'' + row.CodigoBoleto.trim() + '\'); navigationTracking(' + row.SponsorId.trim() + ', \'Mokuteki PLUS\', \'redime kit: ' + row.CodigoBoleto.trim() + ' en: ECU\')" target="_blank" href="https://iw.nikkenlatam.com:8787/login-cupon-incorporate.php?sponsorid=' + window.btoa(row.SponsorId.trim()) + '&kit=' + window.btoa(5002) + '&boleto=' + window.btoa(row.CodigoBoleto.trim()) + '" class="dropdown-item" id="ECU">Ecuador &nbsp;&nbsp;<img src="../fpro/img/flags/' + flags['ECU'] + '" width="20px"></a>' +
                                        '<a onclick="disableButton(\'' + row.CodigoBoleto.trim() + '\'); navigationTracking(' + row.SponsorId.trim() + ', \'Mokuteki PLUS\', \'redime kit: ' + row.CodigoBoleto.trim() + ' en: PAN\')" target="_blank" href="https://iw.nikkenlatam.com:8787/login-cupon-incorporate.php?sponsorid=' + window.btoa(row.SponsorId.trim()) + '&kit=' + window.btoa(5002) + '&boleto=' + window.btoa(row.CodigoBoleto.trim()) + '" class="dropdown-item" id="PAN">Panamá &nbsp;&nbsp;<img src="../fpro/img/flags/' + flags['PAN'] + '" width="20px"></a>' +
                                        '<a onclick="disableButton(\'' + row.CodigoBoleto.trim() + '\'); navigationTracking(' + row.SponsorId.trim() + ', \'Mokuteki PLUS\', \'redime kit: ' + row.CodigoBoleto.trim() + ' en: GTM\')" target="_blank" href="https://iw.nikkenlatam.com:8787/login-cupon-incorporate.php?sponsorid=' + window.btoa(row.SponsorId.trim()) + '&kit=' + window.btoa(5002) + '&boleto=' + window.btoa(row.CodigoBoleto.trim()) + '" class="dropdown-item" id="GTM">Guatemala &nbsp;&nbsp;<img src="../fpro/img/flags/' + flags['GTM'] + '" width="20px"></a>' +
                                        '<a onclick="disableButton(\'' + row.CodigoBoleto.trim() + '\'); navigationTracking(' + row.SponsorId.trim() + ', \'Mokuteki PLUS\', \'redime kit: ' + row.CodigoBoleto.trim() + ' en: SLV\')" target="_blank" href="https://iw.nikkenlatam.com:8787/login-cupon-incorporate.php?sponsorid=' + window.btoa(row.SponsorId.trim()) + '&kit=' + window.btoa(5002) + '&boleto=' + window.btoa(row.CodigoBoleto.trim()) + '" class="dropdown-item" id="SLV">El Salvador &nbsp;&nbsp;<img src="../fpro/img/flags/' + flags['SLV'] + '" width="20px"></a>' +
                                        '<a onclick="disableButton(\'' + row.CodigoBoleto.trim() + '\'); navigationTracking(' + row.SponsorId.trim() + ', \'Mokuteki PLUS\', \'redime kit: ' + row.CodigoBoleto.trim() + ' en: CRI\')" target="_blank" href="https://iw.nikkenlatam.com:8787/costarica/login-cupon-incorporate.php?sponsorid=' + window.btoa(row.SponsorId.trim()) + '&kit=' + window.btoa(5002) + '&boleto=' + window.btoa(row.CodigoBoleto.trim()) + '" class="dropdown-item" id="CRI">Costa Rica &nbsp;&nbsp;<img src="../fpro/img/flags/' + flags['CRI'] + '" width="20px"></a>' +
                                        '<a onclick="disableButton(\'' + row.CodigoBoleto.trim() + '\'); navigationTracking(' + row.SponsorId.trim() + ', \'Mokuteki PLUS\', \'redime kit: ' + row.CodigoBoleto.trim() + ' en: CHL\')" target="_blank" href="https://signup.nikkenlatam.com:8989/profile/ch/spa/kitoneusd/' + window.btoa(row.SponsorId.trim()) + "/" + window.btoa(5002) + "/" + window.btoa(row.CodigoBoleto.trim()) + '" class="dropdown-item" id="CHL">Chile &nbsp;&nbsp;<img src="../fpro/img/flags/' + flags['CHL'] + '" width="20px"></a>' +
                                    '</div>' +
                                '</div>';
                    }
                }
