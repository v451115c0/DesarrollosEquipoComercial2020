                            ...
                            <div class="widget-content widget-content-area event-widget br-4 text-center">
                                <div id="event-card-1" class="card br-4" style="height: auto;">
                                    <div class="form-group mb-4">
                                        <h4 class="text-black">Avances</h4>
                                        <label for="avances">Selecciona año</label>
                                        <select class="form-control-rounded form-control" id="avances" onchange="getRreport(this.value, this.id, 'periodolinkavances')" >
                                    ...
                                    <div class="card-event-icon mt-1 mb-1">
                                        <img src="{{ asset('fpro/img/reconocimientos/GIF.gif') }}" width="80%">
                                    </div>
                                    <div class="card-event-list">
                                    </div>
                                    <div class="card-event-list mt-5">
                                        <a href="/getReportReconocimientos?periodo={{ Date('Y') }}&reporte=avances" id="periodolinkavances" class="btn btn-secondary btn-rounded" target="_new">Descargar reporte</a>
                                    </div>
                                </div>
                            </div>
                        </div>
