...
<div class="row layout-spacing">
    <div class="col-xl-12 col-lg-12 col-md-12 mb-3">
        <div class="alert alert-warning br-50 mb-4 personal-shadow text-center text-black" role="alert" style="font-size: 20px;">
            <strong><i class="flaticon-danger-3"></i> El plazo máximo para hacer registros es hasta el 10 de Noviembre. </strong>
        </div>
    </div>
    ...
    @endphp
    @if (Date('d') < 11)
        <div class="col-xl-5 col-lg-10 col-md-12" hidden>
            <div class="statbox widget box box-shadow">
                <div class="widget-header">
                    ...
                    @else
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center mb-4 text-black">
                                ...
                                <b>NOTA: El plazo máximo para hacer registros es hasta el 10 de Noviembre.</b>
                            </div>
                        </div>
                    @endif
                </div>
