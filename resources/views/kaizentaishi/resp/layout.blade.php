                    ...
                    <ul class="list-unstyled menu-categories" id="accordionExample">
                        <li class="menu">
                            ...
                            <ul class="submenu list-unstyled collapse show" id="ecommerce" data-parent="#accordionExample" style="">
                                <li>
                                    <a href="http://services.nikken.com.mx/kiai/{{ $associateidencode }}">Club Viajeros</a>
                                </li>
                                <li>
                                    <a href="http://services.nikken.com.mx/viajeros_premium/{{ $associateidencode }}" target="_new">Viajeros Premium</a>
                                </li>
                                <li>
                                    <a href="http://services.nikken.com.mx/serpro/{{ $associateidencode }}/N">Reto Ser Pro</a>
                                </li>
                                <li>
                                    <a href="http://services.nikken.com.mx/kaizen/{{ $associateidencode }}">Equipo Kaizen</a>
                                </li>
                                <li>
                                    <a href="http://services.nikken.com.mx/taishi/{{ $associateidencode }}" >Equipo Taishi</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
