                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12" style="border-top:4px dotted #0aa6b6;">
                                        <h4 style="color:#e7515a; font-weight:bold;">Upline View</h4>
                                    </div>                 
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                              ...
                              <!--  <div>
                                ...
                                <form action="../upline" method="get" id="formSearch">

                                   <div class="form-row mb-4">
                                        
                                        <div class="form-group col-md-3">
                                            <label for="ID" style="color: #0aa6b6; font-weight:bold;">ID</label>
                                            <input type="text" class="form-control" name="abiID" id="abiID" placeholder="ABI ID" onkeypress="return justNumbers(event);" form="formSearch">
                                        </div>
