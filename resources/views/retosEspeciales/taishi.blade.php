...
<html lang="en">
	<head>
		...
		<title>NIKKEN | Equipo Taishi 2021</title>
        ...
        <style>
            .navHeadWrapperTaishi{
                background: linear-gradient(0.5deg, #f1b6be 0%, #ff5e51 100%) !important;
            }
			...
			.btnExcel {
				background-image: linear-gradient(135deg, #f1b6be 0%, #ff5e51 100%);
				color: black;
			}
			.btnExcel:hover {
				background-image: linear-gradient(135deg, #ff5e51 0%, #f1b6be 100%);
			}
			.page-item.active .page-link {
				background-color: #ff5e51 !important;
				border-color: #ff5e51 !important;
				border-radius: 4px;
				color: black
			}
	...
	<body class="bodyTaishi">
				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-5">
					<div class="row">
						<div class="col-lg-6 col-md-8 col-sm-12 col-12 text-center m-md-auto">
							<img src="{{ asset('fpro/img/retos2021/Taishi_Logo.png') }}" width="80%">
						</div>
							...
							<div class="row ml-1 mr-1 container-fluid pb-4">
								<div class="col-xl-12 col-md-12 col-sm-12 col-12 text-center mt-4">
									@php
										...
										$rangosCompletosN = [7 => 'PLATINO', 8 => 'DIAMANTE', 9 => 'DIAMANTE REAL', 'EXE' => "EJECUTIVO"];
									@endphp
									<h4>
								...
								<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 site-content-inner align-self-center mr-auto mt-4">
									<a class="btn btn-classic btn-primary btnModal br-50 col-md-8 mb-2 pt-2 pb-2" href="javascript:void(0)" onclick="getMainPts({{ $associateid }})" role="button" data-toggle="modal" data-target=".bd-estatusper-modal-xl">
										Mis puntos
									</a>
								</div>
							</div>
		...
		<div style="height: 150px; overflow: hidden;">
			<svg viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 40%; width: 100%;">
				  <path d="M0.00,92.27 C216.83,192.92 304.30,8.39 500.00,109.03 L500.00,0.00 L0.00,0.00 Z" style="stroke: none;fill: #f1b6be;"></path>
			</svg>
		</div>
		...
		<div class="requisitos scroll-offset navHeaderWrapper mt-5">
			<div class="container" style="background-color: #ffffff; border-radius: 25px;">
				<div id="whyusWrapperResumen" class="row">
					<div class="col-xl-12 col-md-12 col-sm-12 col-12 text-center mt-4">
						<h2 class="section-title mb-2 mt-3" id="tituloGen">GENEALOGÍA INCORPORACIONES 2021</h2>
					</div>
						...
						<div class="col-lg-12 text-center mb-2" hidden>
							<h4>
								...
								<select class="selectpicker mt-3" id="type" onchange="getDataTrimestre(this.value)">
									...
									<option value="2">Estatus Lideres</option>
								</select>
							</h4>
						</div>
							...
							<table id="resumenP" class="table table-striped table-hover table-bordered sticky-thead" style="width:100%">
								<thead>
									<tr>
										...
										<th class="text-center">VP total</th>
		...
		<div class="requisitos scroll-offset navHeaderWrapper mt-5">
			<div class="container" style="background-color: #ffffff; border-radius: 25px;">
				<div id="whyusWrapperResumenL" class="row">
					<div class="col-xl-12 col-md-12 col-sm-12 col-12 text-center mt-4">
						<h2 class="section-title mb-2 mt-3" id="tituloGen">GENEALOGÍA ESTATUS LÍDERES 2021</h2>
					</div>
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
						<div class="col-lg-12 text-center mb-2" hidden>
							<h4>
			...
			<div class="container" style="background-color: #ffffff; border-radius: 25px;">
				<div id="whyusWrapper" class="row">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 text-center">
						<img src="{{ asset('fpro/img/retos2021/Taishi_Banner.png') }}" width="100%">
					</div>
				</div>
			</div>
		</div>
					...
					<div class="col-xl-12 col-lg-12 col-md-12">
						...
						<div class="row">
							<div class="col-lg-5 mx-auto col-lg-6 col-md-6 site-content-inner text-md-left text-center copyright align-self-center">
								<p class="mt-md-0 mt-4 mb-0">© {{ Date('Y')}} Equipo Taishi {{ Date('Y') }} <a href="https://nikkenlatam.com/oficina-virtual/mexico/">Nikken Latinoamérica</a>.</p>
							</div>
