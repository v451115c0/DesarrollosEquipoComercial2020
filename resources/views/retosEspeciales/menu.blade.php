...
<html lang="en">
	<head>
		...
		<title>NIKKEN | Retos Especiales 2021</title>
		...
		<div id="navHeadWrapper" class="navHeaderWrapper header-image navHeadWrapperClubViajeros">
			...
			<div id="headerWrapper" class="container headerContent">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-5">
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-5">
						<h2 class="text-center mt-2">PROGRAMAS Y RETOS DE NEGOCIO</h2>
						<h4 class="text-center mt-5">Da clic sobre reto o programa que deseas consultar</h4>
					</div>
					<div class="row" style="justify-content: space-evenly">
						
						<div class="col-xl-4 col-lg-4 col-md-6 col-12 layout-spacing mt-3">
								...
								<div id="user-profile-card-1" class="card br-4" style="">
									<div class="card-body p-0">
										...
										<div class="usr-info-meta text-center mb-4">
											<a href="{{ url('/clubViajeros_/' . base64_encode($associateid)) }}" class="btn btn-secondary btn-rounded">Ir al reto</a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="widget-content-area p-0 card-widget-content ">
								<div id="user-profile-card-1" class="card br-4" style="">
									<div class="card-body p-0">
										...
										<div class="usr-info-meta text-center mb-4">
											<a href="{{ url('/equipoKaizen/' . base64_encode($associateid)) }}" class="btn btn-secondary btn-rounded">Ir al reto</a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="widget-content-area p-0 card-widget-content ">
									<div id="user-profile-card-1" class="card br-4" style="">
										<div class="card-body p-0">
											...
											<div class="usr-info-meta text-center mb-4">
												<a href="{{ url('/equipoTaishi/' . base64_encode($associateid)) }}" class="btn btn-secondary btn-rounded">Ir al reto</a>
											</div>
										</div>
									</div>
								</div>
						...
						@if ($rango == 'PLO' || $rango == 'DIA' || $rango == 'DRL' )
							<div class="col-xl-4 col-lg-4 col-md-6 col-12 layout-spacing mt-3">
								<div class="widget-content-area p-0 card-widget-content ">
									<div id="user-profile-card-1" class="card br-4" style="">
										<div class="card-body p-0">
											<div class="usr-img-meta mx-auto text-center mb-5 mt-5">
												<img src="{{ asset('fpro/img/retos2021/reto_ser_pro.png') }}" width="80%">
											</div>
											<div class="usr-info-meta text-center mb-4">
												<a href="{{ url('/restoSerPro/' . base64_encode($associateid)) }}" class="btn btn-secondary btn-rounded">Ir al reto</a>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-xl-4 col-lg-4 col-md-6 col-12 layout-spacing mt-3">
								<div class="widget-content-area p-0 card-widget-content">
									<div id="user-profile-card-1" class="card br-4" style="">
										<div class="card-body p-0">
											<div class="usr-img-meta mx-auto text-center">
												<img src="{{ asset('fpro/img/retos2021/vProLogo.png') }}" width="80%">
											</div>
											<div class="usr-info-meta text-center mb-4">
												<a href="{{ url('/viajeros_premium_/' . base64_encode($associateid)) }}" class="btn btn-secondary btn-rounded">Ir al reto</a>
											</div>
										</div>
									</div>
								</div>
	...
	@if ($rango != 'PLO' && $rango != 'DIA' && $rango != 'DRL')
		<script>
			swal({
				title: '',
				icon: 'info',
				html:'Recuerda que también podrás participar en Equipo Taishi, Reto Ser Pro, Viajeros Premium llegando a rango Platino o mayor.',
				type: 'info',
				padding: '2em',
