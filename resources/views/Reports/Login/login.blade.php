...
<!-- Mirrored from themes.semicolonweb.com/html/canvas/login-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Dec 2020 23:20:59 GMT -->
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			<div class="content-wrap py-0">
				...
				<div class="section p-0 m-0 h-100 position-absolute" style="background: url('{{asset('Reports/img/login-background.jpg')}}') center center no-repeat; background-size: cover;"></div>
						...
						<div class="container-fluid py-5 mx-auto">
							...
							<div class="card mx-auto rounded-0 border-0" style="max-width: 400px; background-color: rgba(255,255,255,0.93);">
								<div class="card-body" style="padding: 40px;">
									<div class="center">
										<a href="#"><img src="{{asset('Reports/img/logonikken.png')}}" alt="Logo"></a>
									</div>
									<br>
							...
							<div class="text-center dark mt-3" style="color: black;"><small>Copyrights &copy; All Rights Reserved by NIKEN Inc.</small></div>
						</div>
					</div>
				</div>
