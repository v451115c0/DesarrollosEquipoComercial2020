						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-12  order-1 text-center">
							<div class="row pb-5">
								...
								<div class="col-lg-12" data-aos="fade-down" data-aos-duration="3000">
									<a class="btn btn-classic btn-primary mr-2 btnPregFrec mt-2 br-50" href="{{ asset('fpro/img/kingo/preguntas_frecuentes.pdf') }}" target="_new">
			...
			<div class="container" style="background-color: white; border-radius: 25px; opacity: 0.95;">
				<div class="row">
					<div class="col-xl-12 col-lg-12 col-md-12 text-center site-header-inner mb-5">
						<h2 class="section-title mb-5">TÉRMINOS Y CONDICIONES</h2>
					</div>
						...
						<div class="row ">
								...
								<div class="row">
									...
									<div class="col-lg-12 text-center">
										<div class="row">
											...
											<div class="col-xl-6 col-lg-6 col-md-2 col-sm-12 mb-4">
												<h5>Tus boletos</h5>
												<div class="table-responsive">
													<table class="table mb-4">
														<thead>
							...
							<div class="col-lg-12 text-center">
								...
								<div class="table-responsive mb-4">
									<table id="boletosDetalleTest" class="table table-striped table-bordered table-hover text-center" >
										<thead>
											...
											<div class="row">
												<div class="col-lg-12 text-center mb-2">
													@if ($detalleBoletos[$i]->semana == 1)
														...
														<h5>
															VP productos de otras lineas: {{ number_format($detalleBoletos[0]->Puntos) }} <br>
															# de boletos: {{ number_format($detalleBoletos[0]->TotalBoletos) }}
														</h5>
													@elseif($detalleBoletos[$i]->semana == 1)
														<h5 class="text-black">Corte 2da semana</h5>
														<h5>
															VP productos de otras lineas: {{ number_format($detalleBoletos[1]->Puntos) }} <br>
															# de boletos: {{ number_format($detalleBoletos[1]->TotalBoletos) }}
														</h5>
													@elseif($detalleBoletos[$i]->semana == 2)
														<h5 class="text-black">Corte 3ra y 4ta semana</h5>
														<h5>
															VP productos de otras lineas: {{ number_format($detalleBoletos[2]->Puntos) }} <br>
															# de boletos: {{ number_format($detalleBoletos[2]->TotalBoletos) }}
														</h5>
													@endif
												</div>
												<div class="col-md-12">
