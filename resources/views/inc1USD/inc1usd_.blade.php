	...
	<body>
			...
			<div class="container" style="background-color: #ffffffdb; border-radius: 25px;">
				<div class="row">
					...
					<div class="col-md-12 text-center mt-3 mb-3 term">
						<button class="btn btn-outline-primary btn-rounded pl-5 pr-5 btnTermCond">
							TÉRMINOS Y CONDICIONES MOKUTEKI PLUS <br> MARZO 2021
						</button>
					</div>
					<div class="col-xl-12 col-lg-12 col-md-12 text-center site-header-inner mb-5 ">
						<embed src="{{ asset('fpro/img/MokutekiPlus.pdf#view=fitV') }}" class="mt-5" type="application/pdf" width="100%" height="800px" />
					</div>
				</div>
				...
				<div class="row" style="justify-content: space-evenly" hidden>
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							Estrategia vigente del 1 al 31 de marzo.
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							Todos los Influencer por cada 150 puntos de VP en el mes de marzo tendrán la posibilidad de redimir un <b>KIT MOKUTEKI</b>.
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							Todos los nuevos influencer que ingresen en el mes de marzo tienen el 10% de descuento, en máximo 3 sistemas de agua participantes en el mismo mes. 
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							Unidades de productos de sistemas de agua aplican y generan bonos de plan de influencia (Venta e incorporación <b>MOKUTEKIS</b> transformado) de acuerdo con la tabla vigente para esta estrategia. 
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							Las incorporaciones con Kit de Influencia regular (5023, 5024, 5025, 5026, 5027 y 5028) se pagarán de acuerdo con la tabla de bonos regular.
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							Aplica para el cumplimiento de requisitos de programas especiales.
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							Los tres sistemas de agua pueden ser en diferentes órdenes de compra.
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							Las tres unidades se pueden combinar entre los códigos de Sistemas de Agua participantes.
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							Si tienes <b>MOKUTEKIS</b> de meses anteriores al mes de marzo que aún no has redimido, en marzo podrán acceder al beneficio del 10%.
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							El descuento no aplica para <b>MOKUTEKIS</b> redimidos en meses anteriores y no tengan pedido registrado bajo su código.
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							Se accederá al beneficio de descuento exclusivamente por la Tienda Virtual a través del botón asignado.
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							Estrategia válida para los países que componen la unidad de mercado de Latinoamérica.
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							No aplica para compras con descuentos en los sistemas de agua a través de miembros de la comunidad.
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							No se acumula con otros descuentos como arma tu entorno ni paquetes con repuestos.
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							No aplica para adquirir a través de alcancía electrónica.
                        </p>
					</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 site-content-inner text-center">
						<i class="flaticon-danger-2" style="font-size: 35px"></i>
						<p class="">
							NIKKEN Latinoamérica se reserva el derecho de interpretación de esta estrategia.
                        </p>
					</div>
				</div>
			</div>
		...
		<style>
			#chat-circle i {
				...
				background-image: linear-gradient(to right, #9434aa 0%, #671d53 100%);
				border-radius: 50%;
				letter-spacing: 0;
			}
						...
						<div class="modal-body">
							<div class="py-3 text-center">
								...
								<video controls="true" class="embed-responsive-item" width="100%">
									<source src="https://vivenikken.s3-us-west-1.amazonaws.com/Estrategias/2021/Paso+1.mp4" type="video/mp4" />
								</video>
								<h4>Paso 2</h4>
								<video controls="true" class="embed-responsive-item" width="100%">
									<source src="https://vivenikken.s3-us-west-1.amazonaws.com/Estrategias/2021/Paso+2.mp4" type="video/mp4" />
								</video>
								<h4>Paso 3</h4>
								<video controls="true" class="embed-responsive-item" width="100%">
									<source src="https://vivenikken.s3-us-west-1.amazonaws.com/Estrategias/2021/Paso+3.mp4" type="video/mp4" />
								</video>
								<h4>Paso 4</h4>
								<video controls="true" class="embed-responsive-item" width="100%">
									<source src="https://vivenikken.s3-us-west-1.amazonaws.com/Estrategias/2021/Paso+4.mp4" type="video/mp4" />
								</video>
								<h4>Paso 5</h4>
								<video controls="true" class="embed-responsive-item" width="100%">
									<source src="https://vivenikken.s3-us-west-1.amazonaws.com/Estrategias/2021/Paso+5.mp4" type="video/mp4" />
								</video>
							</div>
						</div>
					</div>
										...
										<div class="container">
											<div class="row m-auto">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 table-responsive text-center" style="background-color: #ffffffe6; padding-right: 0 !important; padding-left: 0 !important;">
													<h2>kits disponibles por incorporación</h2>
													...
													<table id="summaryTicketsInc" class="table table-striped table-bordered table-hover text-center" >
												...
												<div class="col-lg-12 col-md-12 col-sm-12 col-12 table-responsive text-center" style="background-color: #ffffffe6; padding-right: 0 !important; padding-left: 0 !important;">
													<h2>kits disponibles por venta</h2>
													<div class="col-xl-12 col-lg-12 col-md-12 site-content-inner mt-3 text-center bg-white">
														<span class="flaticon-danger-line mb-3 statusprs" style="font-size: 20px; color: coral;"></span>
														<span class="statusprs" style="color: coral;">La tabla se actualizará cada 10 minutos</span> <br>
														<button class="btn btn-warning btn-rounded mb-4 mr-2" onclick="getTicket()" hidden>Recargar tabla</button>
													</div>
													<table id="summaryTicketsSale" class="table table-striped table-bordered table-hover text-center" >
														<input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}">
														<thead>
															<tr class="text-center ranktabheadder">
                                                                <th>ID</th>
        ...
        <div class="modal fade bd-estatusMkPlus-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-xl" role="document">
				<div class="modal-content">
					<div class="modal-body" style="">
						<div class="row ">
							...
							<div class="col-lg-12 mainModalBody mb-5" style="z-index: 2">
								<div class="row" style="justify-content: space-evenly">
									...
									<div class="col-lg-12 text-center mb-2">
										...
										<h5>
											Tu genealogía: 
											<select class="selectpicker mt-3" onchange="getReportMkPlus()" id="typeGen">
												<option value="1">Grupo Personal</option>
									...
									<div id="historialPuntos" class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-4">
										<div class="container">
											<div class="row m-auto">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 table-responsive text-center" style="background-color: #ffffffe6; padding-right: 0 !important; padding-left: 0 !important;">
													<table id="mainMkPlus" class="table table-striped table-bordered table-hover text-center" >
														<thead>
															<tr class="text-center ranktabheadder">
																...
																<th># sistemas de Agua 10% adquiridos</th>
        ...
        <div class="modal fade bd-tabBonos-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-xl" role="document">
				<div class="modal-content">
					<div class="modal-body" style="">
						<img src="{{ asset('fpro/img/inc1USD/' . $flag[$abiInfo[0]->Pais ?? 'LAT']) }}" width="100%">
					</div>
				</div>
			</div>
		</div>
