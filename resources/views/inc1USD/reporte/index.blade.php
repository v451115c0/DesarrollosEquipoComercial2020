...
<body class="default-sidebar">
            ...
            <div class="container">
                ...
                <div class="page-header">
                    <div class="page-title">
                        <h3>Reportes Kit MOKUTEKI</h3>
                    </div>
                </div>

                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-6 col-12 layout-spacing">
                        <div class="widget-content widget-content-area event-widget br-4 text-center">
                            <div id="event-card-1" class="card br-4" style="height: auto;">
                                ...
                                <div class="card-event-list mt-5">
                                    <a href="{{ url('/reporteMKTInc1USDKitsPeriodo?periodo=202010') }}" class="btn btn-secondary btn-rounded" target="_new">Descargar reporte</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-12 layout-spacing">
                        <div class="widget-content widget-content-area event-widget br-4 text-center">
                            <div id="event-card-1" class="card br-4" style="height: auto;">
                                ...
                                <div class="card-event-list mt-5">
                                    <a href="{{ url('/reporteMKTInc1USDKitsPeriodo?periodo=202011') }}" class="btn btn-secondary btn-rounded" target="_new">Descargar reporte</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-12 layout-spacing">
                        <div class="widget-content widget-content-area event-widget br-4 text-center">
                            <div id="event-card-1" class="card br-4" style="height: auto;">
                                ...
                                <div class="card-event-list mt-5">
                                    <a href="{{ url('/reporteMKTInc1USDKitsPeriodo?periodo=202012') }}" class="btn btn-secondary btn-rounded" target="_new">Descargar reporte</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-12 layout-spacing" w>
                        <div class="widget-content widget-content-area event-widget br-4 text-center">
                            <div id="event-card-1" class="card br-4" style="height: auto;">
                                <div class="card-event-icon mt-1 mb-1">
                                    <img src="https://services.nikken.com.mx/retos/img/excel.png" width="40%">
                                ...
                                <div class="card-event-list">
                                    <p>Resumen kit mokuteki</p>
                                </div>
                                <div class="card-event-list mt-5">
                                    <a href="{{ url('/reportemokutekiResumen') }}" class="btn btn-secondary btn-rounded" target="_new">Descargar reporte</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="widget-content widget-content-area event-widget br-4 text-center">
                            <div id="event-card-1" class="card br-4" style="height: auto;">
                                <div class="form-group mb-4">
                                    <label for="periodoIncFrontal">Selecciona periodo</label>
                                    <select class="form-control-rounded form-control" id="periodoIncFrontal" onchange="getRreport(this.value, this.id)">
                                ...
                                <div class="card-event-list">
                                    <p>Incorporación Frontal</p>
                                </div>
                                <div class="card-event-list mt-5">
                                    <a href="/Incorporacion_Frontal?periodo=202012" id="periodoIncFrontallink" class="btn btn-secondary btn-rounded" target="_new">Descargar reporte</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-12 layout-spacing">
                        <div class="widget-content widget-content-area event-widget br-4 text-center">
                            <div id="event-card-1" class="card br-4" style="height: auto;">
                                <div class="form-group mb-4">
                                    <label for="periodogpFrontal">Selecciona periodo</label>
                                    <select class="form-control-rounded form-control" id="periodogpFrontal" onchange="getRreport(this.value, this.id)">
                                        <option value="0" selected disabled>Periodo</option>
                                        @php
                                            $añoAct = date('o');
                                            $añoAct = $añoAct;
                                ...
                                <div class="card-event-list mt-5">
                                    <a href="/Grupo_Frontalidad?periodo=202012" class="btn btn-secondary btn-rounded" id="periodogpFrontallink" target="_new">Descargar reporte</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $("#periodoIncFrontal").val('0');
        $("#periodogpFrontal").val('0');
        function getRreport(periodo, id){
            if(id == 'periodoIncFrontal'){
                $("#periodoIncFrontallink").attr('href', '/Incorporacion_Frontal?periodo=' + periodo);
            }
            else if(id == 'periodogpFrontal'){
                $("#periodogpFrontallink").attr('href', '/Grupo_Frontalidad?periodo=' + periodo);
            }
        }
    </script>
