...
<head>
    ...
    <title>NIKKEN | Pre Registro Influencers </title>
    ...
    <link rel="stylesheet" href="{{ asset('fproh/maincss/preInscInfluencer/preInscInfluencer.css') }}">
...
<body class="default-sidebar">
            ...
            <li class="nav-item dropdown user-profile-dropdown w-100 text-center">
                <div class="nav-toggle d-inline-block float-left mt-2 ml-2">
                    <a href="javascript:void(0);" class="nav-link sidebarCollapse d-inline-block" data-placement="bottom">
                        <img src="{{ asset('fproh/img/preInscInfluencer/planInf.png') }}" class="img-fluid" alt="logo">
                    </a>
                </div>
                <a class="nav-link user d-inline-block float-right mr-2" aria-haspopup="true" aria-expanded="false">
                    <div class="media">
                        <img src="{{ asset('fproh/img/regactivinf/user.png') }}" class="img-fluid mr-2 main-img" alt="admin-profile">
                        <div class="media-body align-self-center">
                            <h6 class="mb-1">Nikken Latinoamérica</h6>
                            <p class="mb-0">Pre Registro A Influencers</p>
                        </div>
                    </div>
                </a>
            </li>
    ...
    <header class="desktop-nav header navbar fixed-top nav-header-pers">
        <div class="nav-logo mr-3 ml-4 d-lg-inline-block d-none">
            <a class=""> <img src="{{ asset('fproh/img/preInscInfluencer/planInf.png') }}" class="img-fluid" alt="logo"></a>
        </div>
