    ...
    <table style="max-width: 600px; padding: 10px; margin:0 auto; border-collapse: collapse;">
        @php
            ...
            if($lang == 'en'){
                ...
                $title1 = 'Gracias ';
                $title2 = ' por pre-registrarte a NIKKEN Latinoamérica';
        ...
        <tr>
            <td style="background-color: #ecf0f1; border-radius: 35px">
                <div style="color: #34495e; margin: 4% 10% 2%; text-align: justify;font-family: sans-serif">
                    <center>
                        ...
                        <div style="width: 100%;margin:20px 0; display: inline-block;text-align: center">
                            <img style="padding: 0; width: 200px; margin: 5px" src="http://services.nikken.com.mx/fproh/img/preInscInfluencer/planInfC.png">
                        </div>
                    </center>
                    <p>
